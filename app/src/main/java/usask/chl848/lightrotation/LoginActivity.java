...
/**
 * Login page (User id, User name, Color, Mode)
 */
public class LoginActivity extends Activity {
    ...
    static {
        ...
        m_ColorNameMap.put("pink", 0xFFFF69B4);
        m_ColorNameMap.put("orange", 0xFFFF4500);
        m_ColorNameMap.put("darkgreen", 0xFF006400);

    }

    private static final String[] Colors = {"Black", "DarkGrey", "Grey", "LightGrey", "White", "Red", "Green", "Blue", "Yellow", "Cyan", "Magenta", "Aqua", "Fuchsia", "Lime", "Maroon", "Navy", "Olive", "Purple", "Silver", "Teal", "Pink", "Orange", "DarkGreen"};
    ...
    class SpinnerModeSelectedListener implements AdapterView.OnItemSelectedListener {
    ...
    private void exit() {
        new AlertDialog.Builder(LoginActivity.this,  AlertDialog.THEME_HOLO_DARK).setTitle("Warning").setMessage("Do you want to exit?").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
